...
Full form: `review-fix-r2q target=<requirement-dir> ...`. `target=<requirement-dir>` names an r2p requirement directory (`<project>/.req-to-plan/WF-*`); there is no bare-path or `ref=` form for this route.
