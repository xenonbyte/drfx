---
name: review-fix-pr
description: Review and fix PR diffs through the V2 document-review-loop coordinator route.
---
...
Use this Codex skill with required `base=<branch>`, optional `read-only` or `review-and-fix`, optional `guard=git|snapshot`, optional `resume`, optional `rounds=<n>`, optional `root=<project-root>`, and optional `debug`.
