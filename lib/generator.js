...
function reviewAndFixFlowFor(platform, route) {
  ...
  if (route.routeKind === 'r2p') {
    return [
      ...
      `8. After \`apply-r2p-repair\`, stop at checkpoint. Tell the user to run \`r2p-continue\`, let r2p regenerate artifacts, then rerun \`${routeName} workId=<new-or-same-WF-...> <rootToken>\`.`,
