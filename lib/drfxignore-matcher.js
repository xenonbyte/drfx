...
function compilePattern(rawLine) {
  ...
  return { negated, directoryOnly, regExp, pattern };
}
 ...
 *   including duplicates because later duplicate rules can change
 *   last-match-wins semantics — the deterministic identity input.
 */
