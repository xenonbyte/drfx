...
function loadRouteRuleContext({
  ...
  layers.push({ name: 'workflow-hard-constraints', text: HARD_CONSTRAINTS });

  // Layer 1: built-in route rubric
  if (builtInRubric !== null && builtInRubric !== undefined && builtInRubric !== '') {
    layers.push({ name: `built-in-${routeKind}-rubric`, text: String(builtInRubric) });
  }
  ...
  if (resolvedUserRules !== null && resolvedUserRules !== undefined && String(resolvedUserRules).trim() !== '') {
    ...
    layers.push({ name: `user-global-${routeKind}-rules`, text: String(resolvedUserRules).trim() });
  }
  ...
  if (resolvedProjectRules !== null && resolvedProjectRules !== undefined && String(resolvedProjectRules).trim() !== '') {
    ...
    layers.push({ name: `project-local-${routeKind}-rules`, text: String(resolvedProjectRules).trim() });
  }
