...
// Lexically resolve the absolute requirement directory for an r2q route from the
// invocation target + cwd. Cheap and synchronous (no realpath/gate validation): the
// full shape/gate validation lives in resolveR2qTarget (start.js, later tasks).
