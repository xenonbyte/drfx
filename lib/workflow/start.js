...
function maybeWriteR2pReopenLinkReceipt({ projectRoot, targetKey, workId }) {
  ...
  const relativePriorReceipt = path.relative(projectRoot, prior.receiptPath).split(path.sep).join('/');
