...
async function runFileSetStart(parsed, options) {
  ...
  try {
    if (routeKind === 'pr') {
      ...
      // r2p resolves an r2p requirement directory (run.md gate + 03–07 doc chain),
      // NOT a CODE scope traversal. Any gate/shape failure throws ERR_R2P_* and is
