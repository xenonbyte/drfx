...
function reviewedIdentityManifestUpdates(metadata, liveFileSet) {
  ...
  if (metadata.routeKind === 'r2q') {
    // r2q re-anchors the editable 03–07 fingerprint AND the protected run.md sha256.
    // requirementDir is identity-stable (it seeds the target key) so it is not rewritten.
