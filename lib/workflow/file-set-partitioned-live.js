...
function liveFileSetFingerprint(liveFileSet) {
  ...
  // r2p persists its fileSetFingerprint over requirementDir-relative doc names (the
  ...
  // fingerprint matches the persisted r2p identity instead of drifting on path shape.
