...
function buildFinalValidationState(metadata) {
  ...
  return {
    ...
    unresolvedBlockingIssues: unresolvedBlockingIssues(ledger),
    ...
    requiredFullReReviewComplete: fixRoundCurrent && latestFullReviewComplete({ latestReviewer, hasFixRound, round }),
