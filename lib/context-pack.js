...
function buildFileSetContextPack({
  ...
  reviewerGuardBaseline = null,
  fixerGuard = null,
  // r2p carries run.md as a PROTECTED read-only dependency: a [{path, readOnly, sha256}]
  ...
  if (routeKind === 'pr') {
    ...
    // r2p is the requirement-doc backward-fix route: its set is the fixed 03–07 chain
...
// Protected read-only dependencies (r2p's run.md gate). The path is redacted/relativized
