...
async function runCheck(options = {}) {
  ...
  const descriptorDirectory = options.json
    ? fs.mkdtempSync(path.join(options.tmpDir || os.tmpdir(), 'drfx-check-'))
    : path.join(homeDir, '.docs-review-fix', 'capabilities');
  ...
  return {
    ...
    userRules: {
      path: path.join(homeDir, '.docs-review-fix', 'rules'),
      present: fs.existsSync(path.join(homeDir, '.docs-review-fix', 'rules')),
      staleRulePath: path.join(homeDir, '.docs-review-fix', 'RULE.md'),
      staleRulePresent: fs.existsSync(path.join(homeDir, '.docs-review-fix', 'RULE.md'))
    },
    preferences: {
    ...
    projectRules: {
      path: path.join(cwd, '.docs-review-fix', 'rules'),
      present: fs.existsSync(path.join(cwd, '.docs-review-fix', 'rules')),
      staleRulePath: path.join(cwd, '.docs-review-fix', 'RULE.md'),
      staleRulePresent: fs.existsSync(path.join(cwd, '.docs-review-fix', 'RULE.md'))
    },
