...
// ## Active Artifacts plan-stage tokens) is UNCONFIRMED against the real r2p
// serializer. The committed fixture (test/fixtures/r2q/approved/run.md) is
// drfx's own self-authored shape, validated only against this parser — not a
// real r2p output. The parser uses the shapes documented in the approved
// design; adjust the extraction predicates here (only) if a real r2p run.md
// differs. Any run.md fixture you create must stay consistent with what
// parseRunMdGate accepts.
// ---------------------------------------------------------------------------
