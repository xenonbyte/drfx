...
This route accepts only target=<requirement-dir>, optional read-only, optional guard=git|snapshot, optional root=<project-root>, and optional debug. It does not accept ref=, strict, normal, assurance=, ledger=, scope=, base=, review-and-fix, resume, reset, or rounds=.
