...
work_id: WF-20260620-review-fix-code-partitioned-project
requirement: # 优化方案 — `review-fix-code` 解除全项目体量限制(partitioned project review)
...
## Evidence Block
keywords_hit: ['迁移', '项目', '仓库', 'project', '清理', '截断', 'token', 'token', '接入', '集成', '调用', '依赖', '整个', '全部', '所有', 'entire', 'whole', 'full']
repo_baseline_summary: loc=36148, modules=7, monorepo=False, languages=['JavaScript']
linked_context: none
scope_signals: ['整个', '全部', '所有', 'entire', 'whole', 'full']
