...
work_id: WF-20260603-code-review-routes-2026-06
requirement: # code review routes 需求
...
## Evidence Block
keywords_hit: ['重写', '改写', '改用', '替代', '项目', '仓库', 'project', '删除', '角色', 'token', 'token', '调用', '依赖', '整个', 'full']
repo_baseline_summary: loc=0, modules=0, monorepo=False, languages=[]
linked_context: none
scope_signals: ['整个', 'full']
