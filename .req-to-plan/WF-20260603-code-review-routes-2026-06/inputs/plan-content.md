...
|---|---|---|---|---|---|
| SPEC-FR-001, SPEC-IF-001 | Route descriptors | PLAN-TASK-001 | implementation + tests | [COVERED] | Shared route registry and lookup tests. |
| SPEC-FR-002, SPEC-IF-003, SPEC-ERR-002, SPEC-COMPAT-004, SPEC-EDGE-001, SPEC-EDGE-002 | PR route | PLAN-TASK-003 | implementation + tests | [COVERED] | PR resolver tests for base, current branch, merge-base, no fetch, rename/delete file sets. |
| SPEC-FR-003, SPEC-IF-004, SPEC-ERR-003, SPEC-SAFE-005, SPEC-EDGE-003 | CODE route | PLAN-TASK-004 | implementation + tests | [COVERED] | CODE scope resolver tests for root, scope, exclusions, unsafe traversal. |
| SPEC-FR-004, SPEC-STATE-002, SPEC-ERR-004, SPEC-COMPAT-001, SPEC-EDGE-006, SPEC-EDGE-007 | rounds | PLAN-TASK-005 | implementation + tests | [COVERED] | `roundLimit` parser/state/loop tests. |
| SPEC-FR-005, SPEC-IF-005, SPEC-ERR-008, SPEC-EDGE-004, SPEC-EDGE-005 | rulebook | PLAN-TASK-007 | implementation + tests | [COVERED] | PR/CODE rubrics, load order, precedence, conflict tests. |
| SPEC-FR-006, SPEC-IF-006, SPEC-COMPAT-002 | platform generation/install | PLAN-TASK-008 | implementation + tests | [COVERED] | Six route generated outputs and manifest-owned install/uninstall tests. |
| SPEC-FR-007, SPEC-SAFE-004 | workflow lifecycle | PLAN-TASK-009 | implementation + tests | [COVERED] | Coordinator PASS, reviewer read-only, full re-review, write-blocking checks. |
| SPEC-FR-008, SPEC-COMPAT-003 | documentation | PLAN-TASK-010 | implementation + tests | [COVERED] | Aligned README updates and documentation assertions. |
| SPEC-FR-009, SPEC-STATE-004, SPEC-ERR-009, SPEC-ACC-011, SPEC-ACC-012 | defaults and read-only | PLAN-TASK-002, PLAN-TASK-009 | implementation + tests | [COVERED] | Default mode/guard parser tests and read-only no-state/no-PASS workflow tests. |
| SPEC-FR-010, SPEC-SAFE-007, SPEC-ACC-015 | no platform `/review` | PLAN-TASK-008 | implementation + tests | [COVERED] | Generated route text assertions. |
| SPEC-STATE-001, SPEC-STATE-003, SPEC-ERR-005 | target context state | PLAN-TASK-003, PLAN-TASK-004, PLAN-TASK-009 | implementation + tests | [COVERED] | Route/base/scope/file-set identity and stale resume tests. |
| SPEC-SAFE-001, SPEC-SAFE-002, SPEC-SAFE-003, SPEC-ERR-006, SPEC-ERR-007, SPEC-ACC-008, SPEC-ACC-009 | guards | PLAN-TASK-006 | implementation + tests | [COVERED] | File-set git/snapshot guard tests. |
| SPEC-SAFE-006 | forbidden side effects | PLAN-TASK-003, PLAN-TASK-006, PLAN-TASK-008, PLAN-TASK-011 | safety + verification | [COVERED] | No fetch/remote mutation/destructive operation checks. |
| SPEC-OBS-001, SPEC-OBS-002, SPEC-OBS-003, SPEC-EDGE-008 | observability | PLAN-TASK-009, PLAN-TASK-011 | implementation + verification | [COVERED] | Concise output, redaction, residual-risk reporting tests. |
| SPEC-ACC-001 through SPEC-ACC-015 | acceptance scenarios | PLAN-TASK-002 through PLAN-TASK-011 | verification | [COVERED] | Acceptance mapped to targeted tests and final matrix. |
| SPEC-PLAN-001 through SPEC-PLAN-011 | Plan Inputs | PLAN-TASK-001 through PLAN-TASK-011 | implementation + verification | [COVERED] | Each SPEC Plan Input maps to one or more tasks below. |
...
|---|---|---|---|---|---|
| RISK-PLAN-001 | DES-PLAN-010 | SPEC-PLAN-010 | PLAN-TASK-011 | [COVERED] | Route x platform x mode x guard x rounds x rule-file verification matrix. |
| RISK-PLAN-002 | DES-PLAN-002 | SPEC-PLAN-002 | PLAN-TASK-002, PLAN-TASK-003 | [COVERED] | PR parser/base/default tests. |
| RISK-PLAN-003 | DES-PLAN-002 | SPEC-PLAN-002, SPEC-PLAN-004 | PLAN-TASK-002, PLAN-TASK-004 | [COVERED] | CODE parser/scope/exclusion tests. |
| RISK-PLAN-004 | DES-PLAN-003 | SPEC-PLAN-003 | PLAN-TASK-005 | [COVERED] | Rounds validation, loop limit, early stop, no-rounds compatibility. |
| RISK-PLAN-005 | DES-PLAN-005 | SPEC-PLAN-005 | PLAN-TASK-006, PLAN-TASK-009 | [COVERED] | File-set guards, stale state, read-only no-state. |
| RISK-PLAN-006 | DES-PLAN-007 | SPEC-PLAN-007 | PLAN-TASK-008 | [COVERED] | Generated route ownership and owned-only uninstall. |
| RISK-PLAN-007 | DES-PLAN-007 | SPEC-PLAN-007 | PLAN-TASK-008 | [COVERED] | Claude/Codex automatic-fix wording and Gemini advisory-only wording. |
| RISK-PLAN-008 | DES-PLAN-008 | SPEC-PLAN-008 | PLAN-TASK-009 | [COVERED] | Output/redaction/default/debug boundaries. |
| RISK-PLAN-009 | DES-PLAN-006 | SPEC-PLAN-006 | PLAN-TASK-007 | [COVERED] | Rule loading order, precedence, conflict behavior. |
| RISK-PLAN-010 | DES-PLAN-009 | SPEC-PLAN-009 | PLAN-TASK-010 | [COVERED] | README structural alignment and content assertions. |
...
| Upstream ID | Closure |
|---|---|
| SPEC-FR-001 | [COVERED] PLAN-TASK-001. |
| SPEC-FR-002 | [COVERED] PLAN-TASK-003. |
| SPEC-FR-003 | [COVERED] PLAN-TASK-004. |
| SPEC-FR-004 | [COVERED] PLAN-TASK-005. |
| SPEC-FR-005 | [COVERED] PLAN-TASK-007. |
| SPEC-FR-006 | [COVERED] PLAN-TASK-008. |
| SPEC-FR-007 | [COVERED] PLAN-TASK-009. |
| SPEC-FR-008 | [COVERED] PLAN-TASK-010. |
| SPEC-FR-009 | [COVERED] PLAN-TASK-002 and PLAN-TASK-009. |
| SPEC-FR-010 | [COVERED] PLAN-TASK-008. |
| SPEC-IF-001 | [COVERED] PLAN-TASK-001. |
| SPEC-IF-002 | [COVERED] PLAN-TASK-002. |
| SPEC-IF-003 | [COVERED] PLAN-TASK-002 and PLAN-TASK-003. |
| SPEC-IF-004 | [COVERED] PLAN-TASK-002 and PLAN-TASK-004. |
| SPEC-IF-005 | [COVERED] PLAN-TASK-007. |
| SPEC-IF-006 | [COVERED] PLAN-TASK-008. |
| SPEC-STATE-001 | [COVERED] PLAN-TASK-003, PLAN-TASK-004, PLAN-TASK-009. |
| SPEC-STATE-002 | [COVERED] PLAN-TASK-005. |
| SPEC-STATE-003 | [COVERED] PLAN-TASK-003, PLAN-TASK-004, PLAN-TASK-009. |
| SPEC-STATE-004 | [COVERED] PLAN-TASK-009. |
| SPEC-ERR-001 | [COVERED] PLAN-TASK-002. |
| SPEC-ERR-002 | [COVERED] PLAN-TASK-003. |
| SPEC-ERR-003 | [COVERED] PLAN-TASK-004. |
| SPEC-ERR-004 | [COVERED] PLAN-TASK-005. |
| SPEC-ERR-005 | [COVERED] PLAN-TASK-003, PLAN-TASK-004, PLAN-TASK-009. |
| SPEC-ERR-006 | [COVERED] PLAN-TASK-006. |
| SPEC-ERR-007 | [COVERED] PLAN-TASK-006. |
| SPEC-ERR-008 | [COVERED] PLAN-TASK-007. |
| SPEC-ERR-009 | [COVERED] PLAN-TASK-009. |
| SPEC-SAFE-001 | [COVERED] PLAN-TASK-006. |
| SPEC-SAFE-002 | [COVERED] PLAN-TASK-006 and PLAN-TASK-009. |
| SPEC-SAFE-003 | [COVERED] PLAN-TASK-006. |
| SPEC-SAFE-004 | [COVERED] PLAN-TASK-009. |
| SPEC-SAFE-005 | [COVERED] PLAN-TASK-004. |
| SPEC-SAFE-006 | [COVERED] PLAN-TASK-003, PLAN-TASK-006, PLAN-TASK-008, PLAN-TASK-011. |
| SPEC-SAFE-007 | [COVERED] PLAN-TASK-008. |
| SPEC-COMPAT-001 | [COVERED] PLAN-TASK-005. |
| SPEC-COMPAT-002 | [COVERED] PLAN-TASK-008. |
| SPEC-COMPAT-003 | [COVERED] PLAN-TASK-010. |
| SPEC-COMPAT-004 | [COVERED] PLAN-TASK-003. |
| SPEC-OBS-001 | [COVERED] PLAN-TASK-009 and PLAN-TASK-011. |
| SPEC-OBS-002 | [COVERED] PLAN-TASK-009. |
| SPEC-OBS-003 | [COVERED] PLAN-TASK-009. |
| SPEC-ACC-001 | [COVERED] PLAN-TASK-002. |
| SPEC-ACC-002 | [COVERED] PLAN-TASK-003. |
| SPEC-ACC-003 | [COVERED] PLAN-TASK-002 and PLAN-TASK-004. |
| SPEC-ACC-004 | [COVERED] PLAN-TASK-004. |
| SPEC-ACC-005 | [COVERED] PLAN-TASK-005. |
| SPEC-ACC-006 | [COVERED] PLAN-TASK-005. |
| SPEC-ACC-007 | [COVERED] PLAN-TASK-008. |
| SPEC-ACC-008 | [COVERED] PLAN-TASK-006. |
| SPEC-ACC-009 | [COVERED] PLAN-TASK-006. |
| SPEC-ACC-010 | [COVERED] PLAN-TASK-010. |
| SPEC-ACC-011 | [COVERED] PLAN-TASK-002. |
| SPEC-ACC-012 | [COVERED] PLAN-TASK-009. |
| SPEC-ACC-013 | [COVERED] PLAN-TASK-007. |
| SPEC-ACC-014 | [COVERED] PLAN-TASK-004. |
| SPEC-ACC-015 | [COVERED] PLAN-TASK-008. |
| SPEC-EDGE-001 | [COVERED] PLAN-TASK-003. |
| SPEC-EDGE-002 | [COVERED] PLAN-TASK-003 and PLAN-TASK-006. |
| SPEC-EDGE-003 | [COVERED] PLAN-TASK-004. |
| SPEC-EDGE-004 | [COVERED] PLAN-TASK-007. |
| SPEC-EDGE-005 | [COVERED] PLAN-TASK-007. |
| SPEC-EDGE-006 | [COVERED] PLAN-TASK-005. |
| SPEC-EDGE-007 | [COVERED] PLAN-TASK-005. |
| SPEC-EDGE-008 | [COVERED] PLAN-TASK-009. |
| SPEC-PLAN-001 | [COVERED] PLAN-TASK-001. |
| SPEC-PLAN-002 | [COVERED] PLAN-TASK-002 and PLAN-TASK-003. |
| SPEC-PLAN-003 | [COVERED] PLAN-TASK-005. |
| SPEC-PLAN-004 | [COVERED] PLAN-TASK-003 and PLAN-TASK-004. |
| SPEC-PLAN-005 | [COVERED] PLAN-TASK-006. |
| SPEC-PLAN-006 | [COVERED] PLAN-TASK-007. |
| SPEC-PLAN-007 | [COVERED] PLAN-TASK-008. |
| SPEC-PLAN-008 | [COVERED] PLAN-TASK-009. |
| SPEC-PLAN-009 | [COVERED] PLAN-TASK-010. |
| SPEC-PLAN-010 | [COVERED] PLAN-TASK-011. |
| SPEC-PLAN-011 | [COVERED] PLAN-TASK-002, PLAN-TASK-004, PLAN-TASK-007, PLAN-TASK-008, PLAN-TASK-009, PLAN-TASK-011. |
| DES-PLAN-001 | [COVERED] PLAN-TASK-001. |
| DES-PLAN-002 | [COVERED] PLAN-TASK-002, PLAN-TASK-003, PLAN-TASK-004. |
| DES-PLAN-003 | [COVERED] PLAN-TASK-005. |
| DES-PLAN-004 | [COVERED] PLAN-TASK-003, PLAN-TASK-004, PLAN-TASK-009. |
| DES-PLAN-005 | [COVERED] PLAN-TASK-006. |
| DES-PLAN-006 | [COVERED] PLAN-TASK-007. |
| DES-PLAN-007 | [COVERED] PLAN-TASK-008. |
| DES-PLAN-008 | [COVERED] PLAN-TASK-009. |
| DES-PLAN-009 | [COVERED] PLAN-TASK-010. |
| DES-PLAN-010 | [COVERED] PLAN-TASK-011. |
| RISK-PLAN-001 | [COVERED] PLAN-TASK-011. |
| RISK-PLAN-002 | [COVERED] PLAN-TASK-002, PLAN-TASK-003. |
| RISK-PLAN-003 | [COVERED] PLAN-TASK-002, PLAN-TASK-004. |
| RISK-PLAN-004 | [COVERED] PLAN-TASK-005. |
| RISK-PLAN-005 | [COVERED] PLAN-TASK-006, PLAN-TASK-009. |
| RISK-PLAN-006 | [COVERED] PLAN-TASK-008. |
| RISK-PLAN-007 | [COVERED] PLAN-TASK-008. |
| RISK-PLAN-008 | [COVERED] PLAN-TASK-009. |
| RISK-PLAN-009 | [COVERED] PLAN-TASK-007. |
| RISK-PLAN-010 | [COVERED] PLAN-TASK-010. |
